...
<body >	
    ...
    <form method="POST" action="submitCardDetails.php" class="form">
    	<div class="sdiv">
    		<h3>Add Card Details :</h3>

    		<label>Card Type : </label>
    		<select name="cardT" style="margin-left: 40px;">
    		...
    		<input type="Number" name="cardN" style="margin-left: 20px;" required>
    		<br><br>
    		<label>Name : </label>
    		<input type="text" name="name" style="margin-left: 70px;" required>
    		<br><br>
    		<label>Expiry Date : </label>
    		<input type="Date" name="exD" style="margin-left: 30px;" required>
    		<br><br>
    		<label>CVV : </label>
    		<input type="Number" name="cV" style="margin-left: 75px;" pattern="[0-9]{3}" required>
    		<br><br><br>
