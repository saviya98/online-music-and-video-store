...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles/video.css"> <!-- Linking the style sheet-->
                    ...
                    <?php 
                    	...
                    	echo "<tr >";
			                if ($results -> num_rows >0)
							{
								...
								{	
									$id = $row["mvID"];
									  echo " <td><a href='itemPreview.php ?Id=$id'><img src='".$row["mvIMG"]."'"."  id ='mv1' class='movieThumb'></a></td>";
									 
									 $i++;
									 if($i == 4 )
							        {
							        	echo "</tr><tr class = 'mvRow'>";
							        	$i = 0;
							        }
