<?php
	...
	include_once 'config.php';
		...
		$sql = "SELECT * FROM user_details WHERE id = $recordId";
...
<body>
	...
	<form style="border:10px solid #ccc" action="submitUpdateUser.php" method="post">
	  <div class="container">
		...
		<hr>
	 	...
	 	<div class="center">
			   ...
			   <div field> &nbsp &nbsp
				    <b> First Name:</b>
				   <input style="width:300px; margin-right: 50px;" type ="text" id="fname" name="fName" value= "<?php echo $fname?>" required>
				   
				   <b> Last Name:</b>
				   <input style="width:300px;" type ="text" id="lname" value= "<?php echo $lname?>"  name ="lName" required>
				</div>
				...
				<div field>
	    			<label for = "phone"><b>Phone NO:</b></label>
        			 <input type ="tel" name ="phno" size ="30" maxlength ="10" value= "<?php echo $phn?>"
         			pattern = "[0-9]{10}">
				</div>
				<br>
				...
				<div field>
					...
					<input type="password" name="pwd" placeholder="Enter the New Password" id="pwd">
				</div>
	    		<br><br>
				...
				<center>
					<div>
						...
						&nbsp &nbsp
						<button id="btn2" type="submit" onclick ="validatePassword()" class="sign">Update My Account</button> &nbsp &nbsp
